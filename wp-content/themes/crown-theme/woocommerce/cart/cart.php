		...
		<thead>
			<tr>
				...
				<th scope="col" class="product-price">
                    ...
                    <small style="display: block; opacity: .6; line-height: 1;"><?php esc_html_e( 'Per Each', 'woocommerce' ); ?></small>
                </th>
		...
		foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
			...
			<tr>
				...
				<?php if ( wc_coupons_enabled() ) { ?>
                    <div class="coupon">
                        <label for="coupon_code" class="screen-reader-text"><?php esc_html_e( 'Promo:', 'woocommerce' ); ?></label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Promo code', 'woocommerce' ); ?>" /> <button type="submit" class="button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="apply_coupon" value="<?php esc_attr_e( 'Apply promo code', 'woocommerce' ); ?>"><?php esc_html_e( 'Apply Promo Code', 'woocommerce' ); ?></button>
						<?php do_action( 'woocommerce_cart_coupon' ); ?>
                    </div>
				<?php } ?>

                <button type="button" id="clear_shopping_cart__btn" class="button">Clear Cart</button>
