...
$shipping_details = get_post_meta( $order->ID, 'shipping_data', true );
$shipping_details = json_decode( $shipping_details, true );
?>
<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'woocommerce-table__line-item order_item', $item, $order ) ); ?>">
    ...
    <td class="woocommerce-table__product-qty-ordered product-qty-ordered">
        <?php
        echo apply_filters( 'woocommerce_order_item_quantity_html', sprintf( '&times;&nbsp;%s', $qty_display ), $item );
        ?>
	</td>
