...
<section class="woocommerce-order-details addify-quote-details">
		...
		<thead>
			<tr>
				...
				<?php if ( $of_price_display ) : ?>
					<th class="product-price"><?php esc_html_e( 'Requested s Price', 'addify_rfq' ); ?></th>
				<?php endif; ?>
	...
	<div class="cart-collaterals">
		...
		if ( ( in_array( $quote_status, array( 'af_accepted', 'af_in_process' ), true ) || ( in_array( $quote_status, array( 'af_converted' ), true ) && ( empty( $exp_date ) || strcmp( date( 'Y-m-d' ), $exp_date ) <= 0  ) ) ) && $afrfq_enable ) :
			?>
			<form method="post">
