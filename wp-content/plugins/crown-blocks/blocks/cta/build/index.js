...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./blocks/cta/src/editor.scss");
...
function Edit({
  ...
  const TEMPLATE = [['core/heading', {
    level: 3
  }], ['core/paragraph', {}], ['crown-blocks/button', {
    type: 'outline'
  }]];
  const {
    imageId,
  ...
  if (textColor == 'auto' && backgroundColor) {
    blockClasses.push('text-color-' + (_common_js__WEBPACK_IMPORTED_MODULE_1__["default"].isDarkColor(backgroundColor, 0.45) ? 'light' : 'dark'));
  ...
  return [(0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(InspectorControls, {
    ...
    render: ({
      ...
      src: imageData.sizes && imageData.sizes.thumbnail ? imageData.sizes.thumbnail.url : imageData.url
    })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Button, {
      className: 'button',
      onClick: open
    }, "Select Background Image"), imageId && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Button, {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../block.json */ "./blocks/cta/block.json");
/**
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["style-index"], function() { return __webpack_require__("./blocks/cta/src/index.js"); })
