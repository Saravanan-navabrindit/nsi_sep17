...
export default function Edit( { attributes, className, isSelected, setAttributes } ) {
	...
	const TEMPLATE = [
		[ 'core/heading', { placeholder: 'Featured Image Title...', level: 2 } ], // defaults to H1 tag for header block
		[ 'core/paragraph', {} ]
	];
	...
	return [
		...
		<div { ...useBlockProps( customProps ) }>
			...
			<div className="section-content" >
				<div className="inner">
					<div className="section-bg" className={contentBgClass.join(' ')} style={ contentStyle }></div>
