	...
	return (
		...
		<div { ...useBlockProps.save( customProps ) }>
			<div className="inner">
				...
				{ (title != '') && <header class="tab-header">
					<RichText.Content tagName="h3" className="tab-title" value={ title } />
					{ (description != '') && <RichText.Content tagName="p" className="tab-description" value={ description } /> }
				</header> }
