...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.scss */ "./blocks/two-panel/src/editor.scss");
...
function Edit({
  ...
  const ALLOWED_BLOCKS = ['crown-blocks/panel'];
  const TEMPLATE = [['crown-blocks/panel', {}, [['core/paragraph', {
    placeholder: 'Enter panel content...'
  }]]], ['crown-blocks/panel', {}, [['core/paragraph', {
    placeholder: 'Enter panel content...'
  }]]]];
  const {
  ...
  blockClasses.push('panel-layout-' + defaultLayoutBrakpoint + '-' + panelLayoutXl); // This object gets passed in to the 'useBlockProps' function to add our custom properties to the block tag
  ...
  return [(0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(InspectorControls, {
    ...
    title: 'Panel Layout Breakpoint',
    initialOpen: true
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(SelectControl, {
    value: panelBreakpoint,
    onChange: value => setAttributes({
      panelBreakpoint: value,
  ...
  })), ['xs', 'sm', 'md', 'lg'].includes(panelBreakpoint) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "crown-blocks-responsive-device-mode-toggles"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(ButtonGroup, null, ['xs', 'sm', 'md', 'lg', 'xl'].includes(panelBreakpoint) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Button, {
    ...
    class: "sub-label"
  }, "1200px")))), ['xs', 'sm', 'md', 'lg'].includes(panelBreakpoint) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Button, {
    ...
    class: "sub-label"
  }, "992px")))), ['xs', 'sm', 'md'].includes(panelBreakpoint) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Button, {
    ...
    class: "sub-label"
  }, "768px")))), ['xs', 'sm'].includes(panelBreakpoint) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Button, {
    ...
    class: "sub-label"
  }, "576px")))), ['xs'].includes(panelBreakpoint) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Button, {
    ...
    class: "sub-label"
  }, "Base")))))), ['xs', 'sm', 'md', 'lg', 'xl'].includes(panelBreakpoint) && responsiveDeviceMode == 'xl' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
    title: 'Layout',
    initialOpen: true
    ...
    min: 1,
    max: 11
  })), ['xs', 'sm', 'md', 'lg'].includes(panelBreakpoint) && responsiveDeviceMode == 'lg' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
    title: 'Layout',
    initialOpen: true
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(ToggleControl, {
    label: 'Override layout',
    checked: overridePanelLayoutLg,
    onChange: value => {
      setAttributes({
        overridePanelLayoutLg: value
      });
    }
  }), !!overridePanelLayoutLg && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(RangeControl, {
    label: "Panel Distribution",
    value: panelLayoutLg,
    onChange: value => setAttributes({
      panelLayoutLg: value
    ...
    min: 1,
    max: 11
  })), ['xs', 'sm', 'md'].includes(panelBreakpoint) && responsiveDeviceMode == 'md' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
    title: 'Layout',
    initialOpen: true
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(ToggleControl, {
    label: 'Override layout',
    checked: overridePanelLayoutMd,
    onChange: value => {
      setAttributes({
        overridePanelLayoutMd: value
      });
    }
  }), !!overridePanelLayoutMd && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(RangeControl, {
    label: "Panel Distribution",
    value: panelLayoutMd,
    onChange: value => setAttributes({
      panelLayoutMd: value
    ...
    min: 1,
    max: 11
  })), ['xs', 'sm'].includes(panelBreakpoint) && responsiveDeviceMode == 'sm' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
    title: 'Layout',
    initialOpen: true
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(ToggleControl, {
    label: 'Override layout',
    checked: overridePanelLayoutSm,
    onChange: value => {
      setAttributes({
        overridePanelLayoutSm: value
      });
    }
  }), !!overridePanelLayoutSm && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(RangeControl, {
    label: "Panel Distribution",
    value: panelLayoutSm,
    onChange: value => setAttributes({
      panelLayoutSm: value
    ...
    min: 1,
    max: 11
  })), ['xs'].includes(panelBreakpoint) && responsiveDeviceMode == 'xs' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
    title: 'Layout',
    initialOpen: true
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(ToggleControl, {
    label: 'Override layout',
    checked: overridePanelLayoutXs,
    onChange: value => {
      setAttributes({
        overridePanelLayoutXs: value
      });
    }
  }), !!overridePanelLayoutXs && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(RangeControl, {
    label: "Panel Distribution",
    value: panelLayoutXs,
    onChange: value => setAttributes({
      panelLayoutXs: value
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./blocks/two-panel/src/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./blocks/two-panel/src/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./blocks/two-panel/src/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../block.json */ "./blocks/two-panel/block.json");
/**
...
/***/ "./blocks/two-panel/src/editor.scss":
/*!******************************************!*\
  !*** ./blocks/two-panel/src/editor.scss ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./blocks/two-panel/src/style.scss":
/*!*****************************************!*\
  !*** ./blocks/two-panel/src/style.scss ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["style-index"], function() { return __webpack_require__("./blocks/two-panel/src/index.js"); })
