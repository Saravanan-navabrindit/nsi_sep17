...
if(!class_exists('Crown_Block_Member_Index')) {
	class Crown_Block_Member_Index extends Crown_Block {

		public static $name = 'member-index';
		...
		public static function localize_script_data() {
			...
			wp_localize_script( 'crown-blocks-' . self::$name . '-script', 'crownBlockMemberIndexData', $data );
		}
		...
		public static function render( $atts, $content ) {
			...
			if ( empty( $atts['viewAllLinkUrl'] ) ) {
				$filters_args[] = array( 'name' => 'm_keywords', 'type' => 'search', 'expandable' => false, 'placeholder' => 'Search' );
			}
