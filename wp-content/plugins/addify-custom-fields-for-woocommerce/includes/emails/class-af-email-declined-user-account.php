<?php
/**
 * Class AF_Email_Declined_User_Account file.
 *
...
if ( ! class_exists( 'AF_Email_Declined_User_Account', false ) ) :
	 ...
	 *
	 * @class       AF_Email_Declined_User_Account
	 * @version     3.5.0
	 * @package     WooCommerce\Classes\Emails
	 * @extends     WC_Email
	 */
	class AF_Email_Declined_User_Account extends WC_Email {
		...
		public function __construct() {
			$this->id             = 'af_email_declined_user_account';
			$this->customer_email = true;
			$this->title          = __( 'Addify Declined New Account', 'af_custom_fields' );
			$this->description    = __( 'Customer "Declined new account" emails are sent to the customer when admin disapprove the customer account.', 'af_custom_fields' );
			$this->template_base  = AF_CF_PLUGIN_DIR . 'templates/';
			$this->template_html  = 'emails/declined-user-account.php';
			$this->template_plain = 'emails/plain/declined-user-account.php';
		...
		public function get_default_subject() {
			return __( 'Your {site_title} account has been declined by Admin!', 'af_custom_fields' );
		...
		public function get_email_content() {
			...
			return apply_filters( 'addify_email_content_' . $this->id, $this->format_string( get_option('af_c_f_disapproved_email_text') ), $this->object, $this );
